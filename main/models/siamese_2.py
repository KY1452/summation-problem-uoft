...
history = model.fit(X_train_numbers, y_train, validation_data=(X_test_numbers, y_test),
...
# Write to Excel
with pd.ExcelWriter('training_details_shared_2.xlsx', engine='openpyxl') as writer:
...
with open('predicted_results_S2_shared.json', 'w') as json_file:
    json.dump(results, json_file, indent=4)

with open("predicted_results_S2_shared.json", "r") as file:
